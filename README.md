...
- **Veges AI**：个人加密对话历史可跨刷新恢复；明确提出当前日/周工作区复盘时，后端会按当前用户权限直接聚合项目、本人日记、待办活动、未完成待办和风险，不需要逐个选择项目或粘贴已有记录。普通回复与对话分析流式展示正文，工作区复盘、项目总结和 Markdown 待办提取只展示安全进度，最终结果仍由服务端统一保存。
